    /*
 * helpshiftpg.js
 * Helpshift PhoneGap Plugin 4.5.0 for the
 * Helpshift iOS SDK 4.5.0 sdk
 *
...
var HelpshiftPG = {
    ...
    init: function (apiKey, domainName, appId, options) {
        if (options && typeof options === "object") {
            cordova.exec (null, null, "HelpshiftPG", "init", [apiKey, domainName, appId, options]);
        } else {
     ...
     *
     * @example HelpshiftPG.showConversation ();
     *  HelpshiftPG.showConversation ({"gotoConversationAfterContactUs": "NO"});
     */
    showConversation: function (options) {
        if (options && typeof options === "object") {
            cordova.exec (null, null, "HelpshiftPG", "showConversation", [this._processMetadata (options)]);
        } else {
            cordova.exec (null, null, "HelpshiftPG", "showConversation", []);
        }
    },
    ...
    showFAQs: function (options) {
        if (options && typeof options === "object") {
            cordova.exec (null, null, "HelpshiftPG", "showFAQs", [this._processMetadata (options)]);
        } else {
    ...
    showFAQSection: function (faqSectionPublishId, options) {
        if (faqSectionPublishId && typeof faqSectionPublishId === "string") {
            if (options && typeof options === "object") {
                cordova.exec (null, null, "HelpshiftPG", "showFAQSection", [faqSectionPublishId, this._processMetadata (options)]);
            } else {
    ...
    showSingleFAQ: function (faqPublishId, options) {
        if (faqPublishId && typeof faqPublishId === "string") {
            if (options && typeof options === "object") {
                cordova.exec (null, null, "HelpshiftPG", "showSingleFAQ", [faqPublishId, this._processMetadata (options)]);
            } else {
                cordova.exec (null, null, "HelpshiftPG", "showSingleFAQ", [faqPublishId]);
            }
        }
    },
    ...
    setNameAndEmail: function (name, email) {
        ...
        cordova.exec (null, null, "HelpshiftPG", "setNameAndEmail", [lName, lEmail]);
    },
     ...
     *
     * @example HelpshiftPG.showAlertToRateAppWithURL ("itms-apps://itunes.apple.com/app/id460171653");
     */
    showAlertToRateAppWithURL: function (url) {
        ...
        if (url && typeof url === "string") {
            ...
            }, null, "HelpshiftPG", "showAlertToRateAppWithURL", [url]);
        }
    },
     ...
     * @example HelpshiftPG.pauseDisplayOfInAppNotification (true);
     */
    pauseDisplayOfInAppNotification: function (pauseInApp) {
        if (typeof pauseInApp === "boolean") {
            cordova.exec (null, null, "HelpshiftPG", "pauseDisplayOfInAppNotification", [pauseInApp]);
        }
    },
     ...
     *    alert(count);
     *  }
     *  HelpshiftPG.registerInAppNotificationCallback(inAppNotificationCallback);
     */
     ...
     *    if (response === HelpshiftPG.HS_RATE_ALERT_SUCCESS) {
     *      alert("App rated");
     *    }
     *  }
     *  HelpshiftPG.registerAlertToRateAppCallback(alertToRateAppCallback);
     */
     ...
     *  }
     *  HelpshiftPG.registerNotificationCallback(notificationCallback);
     *  HelpshiftPG.getNotificationCountFromRemote(false);
     */
    getNotificationCountFromRemote: function (isAsync) {
        ...
        }, null, "HelpshiftPG","getNotificationCountFromRemote", [isAsync === true ? true : false]);
    },
     ...
     *
     * @example HelpshiftPG.handleRemoteNotification(userInfo);
     */
    handleRemoteNotification: function (notificationInfo) {
        if (notificationInfo && typeof notificationInfo === "object") {
            cordova.exec (null, null, "HelpshiftPG", "handleRemoteNotification", [notificationInfo]);
        }
    },
        ...
        if (options && typeof options === "object") {
            if("hsCustomMetadata" in options && options["hsCustomMetadata"] instanceof Object) {
                ...
                if("hsTags" in customMetadata && customMetadata["hsTags"] instanceof Array) {
                    customMetadata[HelpshiftPG.HS_TAGS_KEY] = customMetadata["hsTags"];
                }
                delete customMetadata ["hsTags"];
                options[HelpshiftPG.HS_CUSTOM_METADATA_KEY] = customMetadata;
            }
